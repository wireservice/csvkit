 ...
 * Sun people can't spell worth damn. "compatibility" indeed.
	.asciz "compatibility"
        ...
        Jonathan The Soon Yew <j.the@iname.com>
    <j.the@iname.com> and Alex van Kaam <darkside@cello.nl>.)
 <j.the@iname.com>) */
...
#define ISN'T		   12 
    (Some conversion-factor data were contributed by Jonathan The Soon Yew
 From HWMon.cpp (Copyright 1998-2000 Jonathan The Soon Yew):
 (These conversions were contributed by Jonathan The Soon Yew
/* linear fits from HWMon.cpp (Copyright 1998-2000 Jonathan The Soon Yew)
/* 	__u16 palette:1; */
	__be32 palette;
