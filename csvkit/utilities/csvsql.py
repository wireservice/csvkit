...
class CSVSQL(CSVKitUtility):
    ...
    def main(self):
        ...
        if self.args.connection_string:
            ...
            sql_table = sql.make_table(csv_table, table_name, no_constraints, metadata)
            sql_table.create()
        ...
        # Writing to file
            ...
            sql_table = sql.make_table(csv_table, table_name, no_constraints)
