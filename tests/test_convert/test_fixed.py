...
class TestFixed(CSVKitTestCase):
    ...
    def test_fixed(self):
        with open('examples/testfixed', 'r', encoding='utf-8') as f:
            with open('examples/testfixed_schema.csv', 'r', encoding='utf-8') as schema:
                output = fixed.fixed2csv(f, schema)

        with open('examples/testfixed_converted.csv', 'r', encoding='utf-8') as f:
            self.assertEqual(f.read(), output)

    def test_fixed_skip_lines(self):
        with open('examples/testfixed_skip_lines', 'r', encoding='utf-8') as f:
            with open('examples/testfixed_schema.csv', 'r', encoding='utf-8') as schema:
