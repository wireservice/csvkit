...
#: Sentinel for use when `None` is an valid argument value
default = object()
...
def deduplicate(values, column_names=False, separator='_'):
    """
    Append a unique identifier to duplicate strings in a given sequence of
    strings. Identifiers are an underscore followed by the occurrence number of
    the specific string.
