...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _setup_for_generate(self):
        ...
        # else "load from discrete forms" mode,
    ...
    def _join_left_to_right(
        ...
        if left is None:
            ...
            # figure out the best "left" side based on our existing forms /
            # entities
            assert prop is None
            (
                left,
            ...
            # "forms" list it should be spliced/appended as well as what
    ...
    def _join_determine_implicit_left_side(
        ...
        if self.from_clauses:
            # we have a list of forms already.  So by definition this
            # join has to connect to one of those forms.
            ...
            # we have no explicit forms, so the implicit left has to
...
class _ORMColumnEntity(_ColumnEntity):
    ...
    def setup_compile_state(self, compile_state):
        ...
        # doesn't actually have any forms that line up, such as when its
        # a scalar subquery.
